...
#
  ...
  ~math
    x > 10
  This is `embedded ProofScript`. And this is how I insert ProofDoc generated by code: $`generating ProofScript`.
  ...
  I can point to a given theory like that: ~ref \bootstrap\classical~. 
